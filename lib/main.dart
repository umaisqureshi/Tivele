...
import 'package:tivele/views/splashPage.dart';
...
class _RootPageState extends State<RootPage> {
  ...
  getLocationAddress() async {
    ...
    if (!serviceEnabled) {
      ...
      if (!serviceEnabled) {
        Get.snackbar("Notification", "Please Enable your GPS/Location first for getting nearby orders!",
            icon: Icon(
              Icons.error_outline,
              color: Colors.white,
            ),
        ...
        if (_permissionGranted == PermissionStatus.denied) {
          ...
          if (_permissionGranted != PermissionStatus.granted) {
            Get.snackbar(
                "Notification", "Please Enable your GPS/Location first for getting nearby orders!",
                icon: Icon(
                  Icons.error_outline,
                  color: Colors.white,
                ),
