...
import 'package:tivele/Provider/orders.dart';
import 'package:tivele/Provider/product.dart';
import 'package:tivele/Provider/user.dart';
import 'package:tivele/global/global.dart';
import 'package:provider/provider.dart';
import 'package:tivele/models/Order/SingleOrder.dart';
import 'package:tivele/models/Order/myOrder.dart';
import 'package:tivele/models/Rules/Rule.dart';
import 'package:tivele/models/product/SingleProduct.dart';
import 'package:tivele/models/product/products.dart';
import 'package:tivele/service/Like/like.dart';
import 'package:tivele/service/Review/Reviews.dart';
import 'package:tivele/service/Rules/Rules.dart';
import 'package:tivele/service/order/orders_service.dart';
import 'package:tivele/service/product/product_service.dart';
import 'package:tivele/service/token_auth/session_service.dart';
import 'package:tivele/ui/order_confirmation.dart';
import 'package:tivele/ui/textfield_widgets/textfield_1.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:tivele/Provider/reviews.dart';
import 'package:tivele/ui/thank_you.dart';
...
*/
    ...
    setState(() {
      ...
      if(product.newPrice!=null)
        {
          totalBeforeTax = product.newPrice + order.shippingCost + order.tiveleFee;
          order.totalAmount =
              product.newPrice + order.gst + order.shippingCost + order.tiveleFee;
          order.userId = myId;
      ...
      if(order!=null && TiveleFee!=null&&OrderGst!=null)
        {
          setState(() {
            order.totalAmount = order.shippingCost+totalBeforeTax+TiveleFee+OrderGst;
          });
        }
    ...
    if(_product!=null)
      {
        ...
        if(product.description.contains("@#@#@")){
          ...
          product.description = itemPhotoUrls[itemPhotoUrls.length-1].toString();
      ...
      if(ProductAmount==null)
        {
          ...
          {
            GrandTotalAmount=order.shippingCost+product.newPrice+TiveleFee+OrderGst;
            GrandtotalAmountText=GrandTotalAmount.toStringAsFixed(1);

            OrderTotalAmount=order.shippingCost+product.newPrice+TiveleFee+OrderGst;
                          ...
                          children: [
                            Container(
                              child: ClipRRect(
                                ...
                                child: itemPhotoUrls.isNotEmpty ? Container(
                            ...
                            Positioned(
                              ...
                              child: Text.rich(
                                TextSpan(
                                  ...
                                  text: "\$ ${product.newPrice == null ? 0 : product.newPrice}",
                                  style: Global.style(
                                    size: 16,
                                    bold: true,
                                  ),
                                  children: [
                                    TextSpan(
                                      text: "\$ ${product.oldPrice == null ? 0 : product.oldPrice}",
                                      style: Global.style(
                                        size: 13,
                                        bold: true,
                                        cut: true,
                              ...
                              Row(
                                children: [
                                  likedProducts == null ||
                                      ...
                                      !likedProducts.any((element) => element.id == product.id)
                                      ?IconButton(
                                  ...
                                  SizedBox(width: 8),
                                  Text(
                                    "Liked by " + product.likeCount.toString() + " people",
                                    style: Global.style(),
                                  ),
                                ],
                              ),
                                ...
                                child: Row(
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.network(
                                        rev[index].user.userProfile != null ?rev[index].user.userProfile.url : Global.defaultUserPic,
                                        height: 70,
                                        width: 70,
                                        fit: BoxFit.cover,
                                      ),
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  child: Row(
                                                    children: [
                                                      RatingBar.builder(
                                                        initialRating:  rev[index].rating,
                                                        minRating: 1,
                                                        direction: Axis.horizontal,
                                                        allowHalfRating: true,
                                                        itemCount: 5,
                                    ...
                                    setState(() {
                                      if (order.quantity == 1) {
                                        Fluttertoast.showToast(
                                            msg: "Quantity can not be less than 1",
                                      ...
                                      OrderTotalAmount=order.shippingCost+ProductAmount+TiveleFee+OrderGst;
                                      OrdertotalAmountText=OrderTotalAmount.toStringAsFixed(1);
                                      if(tipController.text.isEmpty){
                                        GrandTotalAmount=order.shippingCost+ProductAmount+TiveleFee+OrderGst;
                                      }else{
                                        GrandTotalAmount=order.shippingCost+ProductAmount+TiveleFee+OrderGst+double.parse(tipController.text);
                                      }
                                      if(orderIndex==0){
                                        tipValue = (5/100)*OrderTotalAmount;
                                        orderTotal = (OrderTotalAmount + tipValue).toStringAsFixed(1);
                                        GrandTotalAmount=order.shippingCost+ProductAmount+TiveleFee+OrderGst+tipValue;
                                      }
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: orderIndex!=4?Colors.black:Colors.white,
  ...
  Widget pic_listget(itemPhotoUrl, int index){
    return checkMedia[index]=="image"?Image.network(
      itemPhotoUrl,
      fit: BoxFit.cover,
      height: MediaQuery.of(context).size.width / 1.3 - 25,
      width: 50,
  ...
  Widget tipButton(int index){
    return SizedBox(
      ...
      child: RaisedButton(
        ...
        textColor: orderIndex == 0 && index == 0 ? Colors.black:orderIndex == 1 && index == 1? Colors.black:orderIndex == 2 && index == 2? Colors.black:orderIndex == 3 && index == 3? Colors.black:Colors.white,
        splashColor: orderIndex == 0 && index == 0 ? Colors.black:orderIndex == 1 && index == 1? Colors.black:orderIndex == 2 && index == 2? Colors.black:orderIndex == 3 && index == 3? Colors.black:Colors.white,
        color:  orderIndex == 0 && index == 0? Colors.white : orderIndex == 1 && index == 1? Colors.white:orderIndex == 2 && index == 2? Colors.white:orderIndex == 3 && index == 3? Colors.white:Colors.black,
        onPressed: (){
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text(index==0?"5 %":index==1?"10 %":index==2?"15 %":"20 %", style: TextStyle(color: orderIndex == 0 && index == 0 ? Colors.black:orderIndex == 1 && index == 1? Colors.black:orderIndex == 2 && index == 2? Colors.black:orderIndex == 3 && index == 3? Colors.black:Colors.white, fontSize: 12),),
          ],
        ),
      ),
    );
  ...
  Widget tip_TextField(){
    return TextFormField(
        ...
        maxLines: 1,
        style: TextStyle(color: orderIndex!=4?Colors.white:Colors.black, fontSize: 16),
        ...
        decoration: InputDecoration(
          ...
          hintText: "",
          hintStyle: TextStyle(color: orderIndex!=4?Colors.white:Colors.black, fontSize: 18),
          suffixIcon:  Icon(
  ...
  Widget buildAttributeValuesWidget(BuildContext context,
      ProductAttributes attribute) {
    int i;
    if(attribute!=null && order!=null && order.orderProductAttributes!=null )
      {
              ...
              children: [
                ...
                Theme(
                  ...
                  child: attribute.attributeType == 1
                    ...
                    materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                    activeColor: Colors.white,
                    value:  attribute.productAttributeValues[index].isChecked,
                    onChanged: (newValue) {
                      var value;
                      setState(() {
                        value=newValue;
                        ...
                        if (value==true) {
                          ...
                          attribute.productAttributeValues[index].isChecked=newValue;

                          print(attribute.productAttributeValues[index].isChecked);
                          order.orderProductAttributes[i]
                              .productAttributeValueId = attribute
                              .productAttributeValues[index].id;
                        }
...
*/
  void setError(dynamic error) {
    _scaffoldKey.currentState
        .showSnackBar(SnackBar(content: Text((error as PlatformException).message)));
    setState(() {
