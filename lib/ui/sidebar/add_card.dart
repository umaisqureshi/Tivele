...
import 'package:tivele/service/BankCard/card.dart';
import 'package:provider/provider.dart';
import 'package:tivele/Provider/card.dart';
...
class _NewPaymentCardState extends State<NewPaymentCard> {
                ...
                children: [
                  ...
                  MyTextField(
                    type: TextInputType.number,
                      hint: 'CVV', controller: cvvController, readOnly: false),
                  SizedBox(height: 24),
                  /*InkWell(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  CreateBankCard() async {
    ...
    try {
      ...
      if (res) {
        await showSuccessToast("Card is created Sucessfully");
