...
import 'package:tivele/ui/categories_list.dart';
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index)
                    {
                      return  Row(
                        ...
                        children: [
                      CategoryItem(
                      asset: requests[index].productCategoryImage == null
                      ? Global.burger
                          : requests[index].productCategoryImage.url,
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => ItemDetails(id:categortProduct[index].id),
                          ),
                        );
                      },
                      child: Container(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  categortProduct[index].productImage == null
                                      ? Global.burger
                            ...
                            Row(
                              children: [
                                RatingBar.builder(
                                  initialRating:
                                      categortProduct[index].ratingAverage,
                                  minRating: 1,
