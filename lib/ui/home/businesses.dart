...
import 'package:tivele/ui/business_profile.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body:ModalProgressHUD(
          child: requests.length==0?Center(child: Container(
            child: Text("No Data to show",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),),
          )): Container(
                  ...
                  children: [
                      ...
                      child: InkWell(
                        onTap: () {
                          getBusinessUserProfile(
                              requests[index].businessAccount.id, context);
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) => BusinessProfile(requests[index].businessAccount.id),
                            ),
                          );
                        },
                        child: Text(
                    ...
                    Stack(
                      children: [
                        GestureDetector(
                          onTap: () {
                            getProductDetail(requests[index].id, context);
                            getProductReview(requests[index].id, context);
                            Navigator.of(context).push(
                              MaterialPageRoute(
                        ...
                        children: [
                          Container(
                              child: Row(
                                ...
                                children: [
                                  RatingBar.builder(
                                    initialRating: requests[index].ratingAverage,
                                    minRating: 1,
                          ...
                          Row(
                            children: [
                              likedProducts == null ||
                                  ...
                                  !likedProducts.any((element) => element.id == requests[index].id)
                                  ?IconButton(
                                icon: Icon(Icons.favorite_border,
                                    color: Colors.grey),
                                padding: EdgeInsets.all(1.0),
                                onPressed: () {
                                  _pressed(false,requests[index],user);
                                },
                              )
                                  :IconButton(
                                ...
                                padding: EdgeInsets.all(1.0),
                                onPressed: () {
                                  _pressed(true,requests[index],user);
                                },
                              ),
                              SizedBox(width: 8),
                              Text(
                                "Like by " +
                                    (requests[index].likeCount != null
                                        ? requests[index]
                                        .likeCount
                                        .toString()
                                        : "0") +
