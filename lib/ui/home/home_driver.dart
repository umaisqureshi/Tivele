                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          divUser==null||divUser.profileImage == null? "https://t4.ftcdn.net/jpg/02/23/50/73/360_F_223507349_F5RFU3kL6eMt5LijOaMbWLeHUTv165CB.jpg" :divUser.profileImage,
                          //image,
                          fit: BoxFit.cover,
                        ),
                      ),
                   ...
                   // SizedBox(width: 12),
                    Text(
                      divUser.driverName==null?"Driver": divUser.driverName,
                      style: Global.style(
                        bold: true,
                        size: 20,
                      ),
                          ...
                          children: [
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    divUser.orders[index].productName == null ? "product name" : divUser.orders[index].productName,
                                    style: Global.style(),
                                  ),
                                ),
                              ),
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    _getDateText(divUser.orders[index].deliveryTime),
                                    style: Global.style(),
                                  ),
                                ),
                              ),
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    _getTimeText(divUser.orders[index].deliveryTime.toLocal()),
                                    style: Global.style(),
                                  ),
                                ),
                              ),
