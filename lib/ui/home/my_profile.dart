...
import 'package:tivele/ui/sidebar/businesseditprofile.dart';
import 'package:tivele/ui/sidebar/card.dart';
import 'package:tivele/ui/sidebar/contact_us.dart';
import 'package:tivele/ui/sidebar/edit_profile.dart';
...
import 'package:tivele/ui/upload_item.dart';
...
class _MyProfileState extends State<MyProfile> {
 ...
 // context.read<ProductsProvider>().getProductByBusiness(widget.businessAccountId);
  ...
  getData()async{
    ...
    await context.read<BusinessUsersProvider>().getBussinessUsers(widget.businessAccountId);
    setState(() {
      isBusy = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    SafeArea(
      child: Scaffold(
        ...
        body:bsUser.businessAccountImage==null?Center(
            child: CircularProgressIndicator(
                valueColor:  new AlwaysStoppedAnimation<Color>(
            Colors.black))): Container(
          padding: EdgeInsets.symmetric(
            horizontal: 16,
            vertical: 12,
          ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: Colors.white,//bsUser.businessAccountImage.url,
                                  ),
                                ),
                                child: ClipRRect(
                                  borderRadius: BorderRadius.all(
                                  ...
                                  child: isGalleryImage
                                    ...
                                    fit: BoxFit.cover,
                                      ...
                                      : Image.network(
                                    GlobalProperties.profileImageUrl,
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
