...
import 'package:tivele/ui/categories.dart';
import 'package:tivele/ui/item_details.dart';
...
class _SearchState extends State<Search> {
  ...
  bool isBusy=true;
  List<ProductCategory> requests;
  List<Items> categortProduct=[];
  List<Items> distance=[];
  List<Items> FilteredProducts=new List();
  List<Items> DistanceProducts=new List();
  _SearchState() {
                                        ...
                                        children: [
                                          Container(
                                            child: ClipRRect(
                                              ...
                                              categortProduct.length>0?  
                                              Image.network(
                                                categortProduct[index].productImage==null?burger:
                                                categortProduct[index].productImage.url,
                                              ...
                                              :Image.network(
                                                distance[index].productImage==null?burger:
                                                ...
                                                onTap: (){
                                                  getBusinessUserProfile(
                                                      distance[index].businessAccount.id,
                                                      context);
                                                  Navigator.of(context).push(

                                                    MaterialPageRoute(
                                                      builder: (_) => categortProduct.length>0?
                                                      ItemDetails(id:categortProduct[index].id)
                                                          :
                                                      ItemDetails(
                                                          id:distance[index].id),
                                                    ),
                                                  );
                                      ...
                                      return GestureDetector(
                                        onTap: () {
                                          ...
                                          Navigator.of(context).push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (_) => FilteredProducts.length>0?
                                              ItemDetails(id:FilteredProducts[index].id)
                                                  :
                                              ItemDetails(
                                                  id:DistanceProducts[index].id),
                                            ),
                                          );
                                             filterController.text="";
                                            // categortProduct.clear();
                                        ...
                                        child: Container(
                                          child: ClipRRect(
                                            ...
                                            Image.network(
                                                FilteredProducts[index].productImage!=null?FilteredProducts[index].productImage.url:burger
                                            ...
                                            Align(
                                              ...
                                              ,
                                                ...
                                                :
                                            Image.network(
                                              DistanceProducts[index].productImage == null
                                                  ? Global.burger
                                                  : DistanceProducts[index].productImage.url,
                                              fit: BoxFit.cover,
                                            ),
