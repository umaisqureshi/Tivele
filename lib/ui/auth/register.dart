...
import 'dart:io';
import 'dart:math';
import 'package:tivele/main.dart';
...
import 'package:tivele/service/account/account_service.dart';
import 'package:tivele/service/token_auth/token_auth_service.dart';
import 'package:tivele/ui/auth/login_user.dart';
import 'package:tivele/ui/auth/register_business2.dart';
...
class _RegisterState extends State<Register> {
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: IconButton(
                                iconSize: 10,
                                icon: Icon(FontAwesomeIcons.facebookF,color: Colors.black,size: 16) ,
                                onPressed: (){
                            ...
                            Visibility(
                              ...
                              child: Container(
                                ...
                                child: IconButton(
                                  iconSize: 10,
                                  icon: Icon(FontAwesomeIcons.instagram,color: Colors.black,size: 16) ,
                                  onPressed: (){
                                    //_handleFacebookSignUp(context);
                                  },
                                ),
                            ...
                            Container(
                              ...
                              child: IconButton(
                                iconSize: 10,
                                icon: Icon(FontAwesomeIcons.google,color: Colors.black,size: 16) ,
                                onPressed: (){
  ...
  Future<void> _registerAccount() async {
    ...
    try{
      ...
      if (signUpRes) {
        await showSuccessToast("User is Registered Successfully");
        Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
            builder: (_) => LoginUser(),
          ),
