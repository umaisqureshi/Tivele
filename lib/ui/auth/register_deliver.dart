...
class _RegisterDeliverState extends State<RegisterDeliver> {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController firstNameController = TextEditingController(text:indiUser.name);
    TextEditingController lastNameController = TextEditingController(text:indiUser.userName);
    TextEditingController emailAddressController = TextEditingController(text:indiUser.emailAddress);
                        ...
                        Container(
                            ...
                            child: Stack(children: [
                              ClipRRect(
                                  ...
                                  child: _newProfileImage ? Image.file(
                                    _profileImage,
                                    fit: BoxFit.fitWidth,
                                  )
