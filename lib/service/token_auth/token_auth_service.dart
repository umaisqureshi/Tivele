...
class TokenAuthService {
  ...
  static Future<bool> authenticate(account) async {
    ...
    print("user123");
    SessionService.addEmailAndPassword(account['userNameOrEmailAddress'], account['password']);
  ...
  static Future<bool> externalAuthenticate({
    ...
    final result = RequestResponse.getResult(response);
    SessionService.addExternalAuthenticateData(authProvider, providerKey, providerAccessCode);
    return addAccessToken(result);
  }
