...
import 'package:tivele/controllers/customer/customerHomeController.dart';
import 'package:tivele/controllers/customer/customerHomeController2.dart';
...
import 'package:tivele/service/account/user_service.dart';
...
class _BusinessesState extends State<CustomerBusinessesHomePage> {
  ...
  final CustomerHomeController customerHomeController = Get.put(CustomerHomeController());
  final CustomerHomeController2 customerHomeController2 = Get.put(CustomerHomeController2());
  final CustomerAddLikeController customerAddLikeController = Get.put(CustomerAddLikeController());
  //Items _product;
  bool Liked = false;
  ...
  getLocationAddress(List<ProductM> productD, int likes, String rating, bool isLiked, ProductDatum productDataList) async {
    serviceEnabled = await location.serviceEnabled();
    if (!serviceEnabled) {
      print("asli");
      serviceEnabled = await location.requestService();
      if (!serviceEnabled) {
        Get.snackbar("Notification", "Please Enable your GPS/Location to  book order",
            icon: Icon(
              Icons.error_outline,
              color: Colors.white,
            ),
        ...
        body: globals.checkLogin?InkWell(
          ...
          if (customerHomeController.isLoading.value) {
            ...
            if (checkInitialProducts) {
              productDataList = customerHomeController.homeINfo.value.data;
            }
            ...
            return SmartRefresher(
              ...
              child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                        itemPhotoUrls.clear();
                        checkMedia.clear();
                        if (productDataList[index].productImages.contains(",")) {
                          itemPhotoUrls = productDataList[index].productImages.split(",");
                          ...
                          itemPhotoUrls.add(productDataList[index].productImages);
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  Get.to(BusinessProfileFollowPage(), arguments: [
                            ...
                            Stack(
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    productD.add(ProductM(
                                        ...
                                        double.parse(
                                            productDataList[index].shippingCost),
                                        productDataList[index].latitude,
                                        productDataList[index].longitude));
                                    getLocationAddress(productD, productDataList[index].likes, productDataList[index].rating,productDataList[index].isLiked, productDataList[index]);
                                  },
                                  child: Container(
                                    child: ClipRRect(
                                ...
                                Positioned(
                                  ...
                                  child: Text.rich(
                                    TextSpan(
                                      text: "\$" + productDataList[index].newPrice,
                                      style: Global.style(
                                        size: 16,
                                        bold: true,
                                      ),
