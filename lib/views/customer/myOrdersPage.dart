...
import 'package:tivele/controllers/customer/getOrderByUserId.dart';
import 'package:tivele/controllers/customer/orderReviewController.dart';
...
class _MyOrdersState extends State<MyOrdersPage> {
  ...
  final getOrderByUserId getOrderByUserIdController = Get.put(getOrderByUserId());
          ...
          child: getOrderByUserIdController.myorderList.length == 0
            ...
            child: getOrderByUserIdController.myorderList.length > 0
              ...
              child: Column(
                children: [
                  ListView.separated(
                    itemCount: getOrderByUserIdController.myorderList.length,
                        ...
                        child: Row(
                          children: [
                            ClipRRect(
                              ...
                              child: getOrderByUserIdController.myorderList[index].deliveryImage!=""?Image.network(
                                URLS.BASEURL+getOrderByUserIdController.myorderList[index].deliveryImage,
                                height: 70,
                                width: 70,
                                fit: BoxFit.cover,
                              ):Image.asset(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        getOrderByUserIdController.myorderList[index].productName,
                                        style: Global.style(
                                          size: 12,
                                          bold: true
                                        ),
                                      ...
                                      Text(
                                        getOrderByUserIdController.myorderList[index].status,
                                        // ords[index]
                                        //     .product
                                        //     .description,
                                        style: Global.style(
                            ...
                            Container(
                              width:  MediaQuery.of(context).size.width*0.25,
                                child:Visibility(
                                  visible: getOrderByUserIdController.myorderList[index].reviewOrder,
                                  child: InkWell(
                                    child: Text(
                                      "Leave Review",
                                      style: TextStyle(
                                    ...
                                    onTap: () {
                                      leaveReviewDialog(getOrderByUserIdController.myorderList[index].id);
                                    },
                                  ),
                                )
                            )
