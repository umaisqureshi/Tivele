...
import 'package:tivele/controllers/customer/businessFollowController.dart';
import 'package:tivele/controllers/customer/getBusinessProfileByIdController.dart';
...
import 'package:tivele/views/business/businessItemDetail.dart';
...
class _MyProfileState extends State<BusinessProfileFollowPage> {
  ...
  final GetBusinessProfileByIdController getBusinessProfileByIdController = Get.put(GetBusinessProfileByIdController());
  final BusinessFollowController businessFollowController = Get.put(BusinessFollowController());
  bool remember = false;
  File ProfileImage;
  ...
  getData() async {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      print(businessId);
      if (businessId != null) {
        getBusinessProfileByIdController.fetchGetBusinessProfileByIdData(businessId);
      }
    });
  }
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              _pressed(getBusinessProfileByIdController.businessINfo.value.data.products[0].businessId);
                            },
                            style: ElevatedButton.styleFrom(
                                primary: !getBusinessProfileByIdController
                                        .businessINfo.value.data.isFollowed
                                    ? Colors.blueAccent
                                    : Colors.black,
                                side: BorderSide(
                          ...
                          return GestureDetector(
                            onTap: () async{
                              ...
                              productD.add(ProductM(
                                  ...
                                  getBusinessProfileByIdController.businessINfo
                                      .value.data.products[index].categoryName,
                                  getBusinessProfileByIdController.businessINfo
                                      .value.data.products[index].name,
                                  getBusinessProfileByIdController.businessINfo
                                      .value.data.products[index].description,
                                  getBusinessProfileByIdController.businessINfo
                                      .value.data.products[index].productImages,
                                  getBusinessProfileByIdController.businessINfo
                                  ...
                                  double.parse(getBusinessProfileByIdController
                                      ...
                                      .products[index]
                                      .newPrice),
                                  double.parse(getBusinessProfileByIdController.businessINfo.value.data.products[index].oldPrice),
                              ...
                              if(checkLocation){
                                Get.to(CustomerDetailPage(), arguments: [
                                  productD,
                                  int.parse(getBusinessProfileByIdController.businessINfo.value.data.products[index].likes),
                                  getBusinessProfileByIdController.businessINfo.value.data.products[index].rating,
                                  true]);
                              }
                            },
                            child: Container(
