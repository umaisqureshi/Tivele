...
class _SearchState extends State<ExplorePage> {
  ...
  getLocationAddress() async {
    ...
    if (!serviceEnabled) {
      ...
      if (!serviceEnabled) {
        Get.snackbar("Notification", "Please Enable your GPS/Location first to get nearby goods/order",
            icon: Icon(
              Icons.error_outline,
              color: Colors.white,
            ),
        ...
        if (_permissionGranted == PermissionStatus.denied) {
          ...
          if (_permissionGranted != PermissionStatus.granted) {
            Get.snackbar(
                "Notification", "Please Enable your GPS/Location first to get nearby goods/order",
                icon: Icon(
                  Icons.error_outline,
                  color: Colors.white,
                ),
                        ...
                        Obx(() {
                          if (getCategoriesController.isLoading.value) {
                            ...
                            if (currentCategoryId == null) {
                              categories = getCategoriesController.categoryINfo.value.data;
                                    ...
                                    child: SmartRefresher(
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                              ...
                                              itemPhotoUrls.clear();
                                              checkMedia.clear();
                                              if (productsData[index].productImages.contains(",")) {
                                                itemPhotoUrls = productsData[index].productImages.split(",");
                                                ...
                                                itemPhotoUrls.add(productsData[index].productImages);
                                                ...
                                                onTap: () async{
                                                  ...
                                                  productD.add(
                                                      ProductM(
                                                          ...
                                                          productsData[index].businessId,
                                                          productsData[index].categoryName,
                                                          productsData[index].name,
                                                          productsData[index].description,
                                                          productsData[index].productImages,
                                                          productsData[index].status,
                                                          double.parse(productsData[index].newPrice),
                                                          double.parse(productsData[index].oldPrice),
                                                          double.parse(productsData[index].tiveleFee),
                                                          double.parse(productsData[index].gstAmount),
                                                          double.parse(productsData[index].shippingCost),
                                                          productsData[index].latitude,
                                                          productsData[index].longitude));
                                                  if(globals.checkLogin){
                                                    showLoginErrorDialog();
                                                  }else{
                                                    await checkLocationPermissionForRefresh();
                                                    if(checkLocation){
                                                      Get.to(CustomerDetailPage(), arguments: [productD, productsData[index].likes, productsData[index].rating, productsData[index].isLiked,productsData[index]]);
                                                    }
                                                  }
                                                  },
                                                child: Container(
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              onTap: () {
                                                                print(productsData[index].businessId);
                                                                if(globals.checkLogin){
                                                                  showLoginErrorDialog();
                                                                }else{
                                                                  Get.to(
                                                              ...
                                                              child: Text(
                                                                productsData[index].businessName,
                                                                style:
                                                                    Global.style(
                                                                  size: 14,
                                                                  bold: true,
                                                            ...
                                                            Text(
                                                              ...
                                                              (productsData[index].description).length > 120 ?(productsData[index].description).substring(0, 120) : productsData[index].description,
                                                              style: Global.style(
                                                                size: 9,
                                                                bold: false,
                                                                caps: false,
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                ...
                                                                children: [
                                                                  TextSpan(
                                                                    text: (double.parse(productsData[index].distance) /
                                                                                1000)
                                                                            .toStringAsFixed(
                                                                                2) +
                                                                        " km away",
                                                      ...
                                                      Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          ...
                                                          image: DecorationImage(
                                                            image: checkMedia[0] != "image" ? AssetImage("assets/text.png",
                                                            ) : NetworkImage(URLS.BASEURL + itemPhotoUrls[0]),
                                                            fit: BoxFit.fill,
                                                          ),
                                                        ),
                                                        child: Text.rich(
