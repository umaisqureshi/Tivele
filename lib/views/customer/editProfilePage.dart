...
import 'package:tivele/controllers/customer/updateProfileImageController.dart';
import 'package:tivele/controllers/customer/updateUserPasswordController.dart';
...
import 'package:tivele/ui/auth/login_driver.dart';
import 'package:tivele/ui/auth/login_user.dart';
import 'package:tivele/ui/home/home_user.dart';
import 'package:tivele/ui/sidebar/card.dart';
import 'package:tivele/global/global.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:tivele/ui/sidebar/my_orders.dart';
...
import 'package:tivele/views/customer/myOrdersPage.dart';
...
class _EditProfileState extends State<EditProfilePage> {
  final UpdateProfileImageController updateProfileImageController = Get.put(UpdateProfileImageController());
  final UpdateUserPasswordController updateUserPasswordController= Get.put(UpdateUserPasswordController());
  ...
  String ImageId;
  String userName = "";
  String myProfilePic = "https://img.freepik.com/free-photo/portrait-confident-man_102671-5909.jpg";
...
//                ),
  ...
  ChangePassword(BuildContext context) async {
    ...
    try {
      ...
      if (updateUserPasswordController.passwordINfo.value.status==200) {
        await showSuccessToast("Password is changed Successfully");
        setState(() {
          isBusy = false;
        });
        Get.offAll(CustomerLoginPage());
      }
      else if(updateUserPasswordController.passwordINfo.value.status==900) {
  ...
  _UploadProfilePicture(File _profileImage) async {
    ...
    await updateProfileImageController.fetchUpdateImageData(_profileImage, _profileImage.path.split("/").last.toString(), "user");
    print(updateProfileImageController.imageINfo.value.status);
    if(updateProfileImageController.imageINfo.value.status==200){
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setString("user_image", updateProfileImageController.imageINfo.value.data);
