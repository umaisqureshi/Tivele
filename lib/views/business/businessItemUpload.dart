...
import 'package:tivele/controllers/business/addProductController.dart';
import 'package:tivele/controllers/business/getCategoriesController.dart';
import 'package:tivele/controllers/uploadPicController.dart';
import 'package:tivele/controllers/uploadVidController.dart';
import 'package:tivele/global/global.dart';
import 'package:tivele/globals.dart' as globals;
import 'package:tivele/models/business/productAttributeModel.dart';
import 'package:tivele/ui/textfield_widgets/textfield_1.dart';
import 'package:tivele/ui/textfield_widgets/textfield_2.dart' as Text2;
...
class _UploadItemState extends State<BusinessItemUpload> {
                      ...
                      children: [
                        ...
                        Obx(() {
                          if (getCategoriesController.isLoading.value) {
                            ...
                            final categories =
                                getCategoriesController.categoryINfo.value.data;
                            return Container(
                              decoration: BoxDecoration(
                        ...
                        productAttributes.isNotEmpty?addExtraList():Container(),
                        SizedBox(height: 24),
                        Text(
                          'Description',
                          style: Global.style(
  ...
  Widget addExtraList(){
    return ListView.builder(
      ...
      itemBuilder: (context, index) => extraListGet(index, productAttributes[index]),
    );
  }
            ...
            InkWell(
              onTap: (){
                setState(() {
                  ...
                  productAttributes.removeWhere((attribute) =>  attribute.attributeName==productAttribute.attributeName);
                });
              },
              child: Icon(
            ...
            children: [
              Row(
                children: [
                  ...
                  InkWell(
                      onTap: (){
                        attributeNameController.text = productAttribute.attributeValues[indexA];
                       openAttributeUpdateDialog("Update Attribute Value", index, indexA);
                      },
                      child:  Icon(
                        Icons.edit,
                        size: 18,
                    ...
                    onTap: (){
                        setState(() {
                          //productAttributes[index].attributeValues[indexA] = "ALIuaj";
                           productAttributes[index].attributeValues.removeWhere((attribute) =>  attribute==productAttribute.attributeValues[indexA]);
                           if(productAttributes[index].attributeValues.isEmpty){
                             productAttributes.removeWhere((attribute) =>  attribute.attributeName==productAttribute.attributeName);
                           }
                        });
                    },
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                if(attributeNameController.text.trim().isEmpty){
                                  showErrorToast("Please enter Attribute Name!");
                                }else{
                                  if(!productAttribute.attributeValues.contains(attributeNameController.text.trim())){
                                    setState(() {
                                      productAttribute.attributeValues.add(attributeNameController.text.trim());
                                ...
                                if(attributeNameController.text.trim().isEmpty){
                                  ...
                                  setState(() {
                                    if(heading=="Update Attribute Name"){
                                      if(productAttributes.any((attribute) => attribute.attributeName==attributeNameController.text.trim())){
                                        showErrorToast("Attribute Name Already Exists!");
                                      }else{
                                        productAttributes[index].attributeName = attributeNameController.text.trim();
                                        attributeNameController.text = "";
                                        Navigator.pop(context);
                                      }
                                    }else{
                                      if( productAttributes[index].attributeValues.any((attribute) => attribute==attributeNameController.text.trim())){
                                        showErrorToast("Attribute Value Already Exists!");
                                      }else{
                                        productAttributes[index].attributeValues[indexA] = attributeNameController.text.trim();
                                        attributeNameController.text = "";
                                        Navigator.pop(context);
                                      }
                                    }
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: IconButton(
                                onPressed: () {
                                  if(attributeValues.any((attribute) => attribute.attributeValue==attributeValueController.text.trim())){
                                    showErrorToast("Attribute Value Already Exists!");
                                  }else{
                                    setState(() {
                                      if(attributeValueController.text.trim().isNotEmpty){
                                        attributeValues.add(AttributeValues(attributeValueController.text.trim()));
                                        attributeValueController.text = "";
                                      }else{
                                        showErrorToast("Please add attribute value!");
                                        attributeValueController.text = "";
                                      }
                                    });
                                  }
                              ...
                              child: MaterialButton(
                                onPressed: () {
                                  if(attributeNameController.text.trim().isEmpty){
                                    ...
                                    showErrorToast("Please enter atleast one Attribute Value!");
                                  }else{
                                    if(productAttributes.any((attribute) => attribute.attributeName==attributeNameController.text.trim())){
                                      showErrorToast("Attribute Name Already Exists!");
                                    }else{
                                      setState(() {
                                        ...
                                        for(var val in attributeValues){
                                          tempAtt =tempAtt + val.attributeValue+"##";
                                        }
                                        tempAtt = tempAtt.substring(0, tempAtt.length-2);
                                        //print(tempAtt);
                                        productAttributes.add(ProductAttributes(attributeNameController.text.trim(), tempAtt.split("##")));
                                        attributeNameController.text = "";
                                        //attributeValues.clear();
                                      });
                                      Navigator.pop(context);
                      ...
                      attributeValues.isNotEmpty?ListView.builder(
      ...
      try {
        ...
        for (var file in selectedMedias) {
          ...
          if (fileType[0] == "image") {
            ...
            await uploadVidController.fetchVid(
        ...
        globals.showErrorSnackBar("Item is not uploaded: Error("+err.toString()+")");
        print(err);
      }
    }
  }
