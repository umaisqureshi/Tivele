...
import 'package:tivele/service/DriverAccount/driverAccount.dart';
...
import 'package:tivele/ui/auth/login_business.dart';
import 'package:tivele/ui/textfield_widgets/textfield_2.dart';
import 'package:tivele/views/business/businessLoginPage.dart';
import 'package:tivele/views/customer/customerRegistrationPage.dart';
import 'package:tivele/views/driver/driverRegistrationPage.dart';
...
class _RegisterBusiness2State extends State<BusinessRegistrationPage> {
  final UploadPicController uploadPicController = Get.put(UploadPicController());
  ...
  void _getImage() async {
    final pickedFile = await picker.getImage(
        source: ImageSource.gallery, maxHeight: 800, maxWidth: 800, imageQuality: 70);
    if (pickedFile != null) {
      setState(() {
  ...
  RequestForBusinessAccount() async {
    ...
    try{
      ...
      if(_newProfileImage){
        await uploadPicController.fetchPic(_profileImage, _profileImage.path.split("/").last.toString(), 0,"Business Registration");
