...
import 'package:tivele/models/business/businessPofileM.dart';
...
class _BusinessDetailPageState extends State<BusinessDetailPage> {
  ...
  Product productData = Get.arguments[4];
  int likes = 0;
  String rating;
  // double rating = double.parse(Get.arguments[2]);
  bool isLiked = false;
  bool checkTip = false;
  String orderTotal;
 ...
 // Token _paymentToken;
  ...
  // List<ProductDetailsDatum> productDataList = [];
  // void loadData() async {
  //   print("getting data");
  ...
  //         print("lengthhhh");
  //         print(productDataList[0].likes.toString() + "abc");
...
/*
    StripePayment.setOptions(StripeOptions(
        publishableKey:
            "pk_test_51Igno7CVzIpv7T9Kc656wg8BDpPtSFhPtMYScVu4tDJPck5bvIQurnY7hWUvr0RrmivCiEFyNFiBww5kSOK6BiuI00taaojvaH",
        merchantId: "Test",
        androidPayMode: 'test'));
*/
  ...
  Widget build(BuildContext context) {
    likes = Get.arguments[1];
    rating = Get.arguments[2];
    isLiked = Get.arguments[3];
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    child: Row(
                                                      children: [
                                                        RatingBar.builder(
                                                          initialRating: rating==null?5:rating,
                                                          minRating: 1,
                                                          direction:
                                                              Axis.horizontal,
                                                          allowHalfRating: true,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            productData.productAttributes!=[]?addExtraList():Container(),
                            //       SizedBox(height: 24),
                            //       Container(
                            //         alignment: Alignment.center,
                            //         width: double.infinity,
  ...
  Widget addExtraList(){
    return ListView.builder(
      ...
      shrinkWrap: true,
      physics: NeverScrollableScrollPhysics(),
      itemCount: productData.productAttributes.length,
      itemBuilder: (context, index) => extraListGet(index, productData.productAttributes[index]),
    );
  }
  ...
  Widget pic_listget(itemPhotoUrl, int index) {
    ...
    return checkMedia[index] == "image"
        ? CachedNetworkImage(
      imageUrl: URLS.BASEURL + itemPhotoUrl,
      ...
      progressIndicatorBuilder: (context, url, downloadProgress) =>
          Padding(
            padding: EdgeInsets.only(left: MediaQuery.of(context).size.width*0.2, right: MediaQuery.of(context).size.width*0.2, top: 20, bottom: 20),
