...
import 'package:tivele/controllers/driver/orderPickedByDriverController.dart';
...
import 'package:tivele/views/driver/driverHomePage.dart';
...
class _AcceptDeliveryState extends State<AcceptDelivery> {
                                    ...
                                    children: [
                                        GoogleMap(
                                          ...
                                          markers: {
                                            ...
                                            // ),
                                            Marker(
                                              position: LatLng(double.parse(widget.order.productLatitude), double.parse(widget.order.productLongitude)),
                                          ...
                                          initialCameraPosition: CameraPosition(
                                            target: LatLng(double.parse(widget.order.productLatitude), double.parse(widget.order.productLongitude)),
                                            zoom: 15.0,
                                          ),
                                             ...
                                             color: Colors.white.withOpacity(0.8),
                                               ...
                                               onPressed: ()async{
                                                 ...
                                                 await availableMaps.first.showMarker(
                                                   coords: Coords(double.parse(widget.order.productLatitude), double.parse(widget.order.productLongitude)),
  ...
  uploadPic(File file) async {
    ...
    medias = medias.substring(0, medias.length - 1); //// this is file's name now transfer it to api

    await acceptOrderController.fetchorderpickedbydriver(medias, widget.order.id);
