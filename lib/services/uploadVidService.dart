...
class UploadVidService {
  static Future fetchvid(File file, String filename) async {
    print("filename:" + filename);

    ///MultiPart request
    var request = http.MultipartRequest(
      'POST',
      Uri.parse(URLS.BASEURL + URLS.upload_video),
    );
    ...
    if (response.body.isNotEmpty) {
      ...
      print(response.body +
          "Upload video success here! 'uploadVIdService class'");
