...
class UpdateProfileImageService {
  ...
  static Future fetchUpdateProfileImage(File file,String filename, String userType)async{
    if(userType=="user"){
    ...
    ///MultiPart request
    var request = http.MultipartRequest('POST', Uri.parse(URLS.BASEURL+userUrl));
