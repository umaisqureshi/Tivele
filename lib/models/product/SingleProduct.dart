...
import 'package:tivele/models/FollowBusinessAccount/followBusiness.dart';
import 'package:tivele/models/product/productBusinessAccount.dart';
...
class SingleProductResult {
  ...
  SingleProductResult.fromJson(Map<String, dynamic> json) {
    result =
    json['result'] != null ? new SingleProduct.fromJson(json['result']) : null;
