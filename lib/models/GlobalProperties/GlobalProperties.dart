...
class GlobalProperties with ChangeNotifier {
  ...
  static String defaultProfileImageUrl = "https://biancazapatka.com/wp-content/uploads/2020/05/veganer-bohnen-burger-500x500.jpg";
  ...
  static void getProfileImageUrl() async{
    ...
    profileImageUrl = imageUrl?.isEmpty ?? true ? defaultProfileImageUrl : imageUrl;
  }
