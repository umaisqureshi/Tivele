...
import 'package:tivele/services/driver/orderService.dart';
class OrderController extends GetxController {
  var orderINfo = OrderServiceModel().obs;
  ...
  pickUpAddress(double pickuplat, double pickuplong, double dropofflat, double dropofflong)async{
    ...
    List<geo.Placemark> placemarks = await geo.placemarkFromCoordinates(pickuplat, pickuplong);
    ...
    List<geo.Placemark> placemarks2 = await geo.placemarkFromCoordinates(dropofflat, dropofflong);
