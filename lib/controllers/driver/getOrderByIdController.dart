...
import 'package:tivele/services/driver/get_orders_by_driver_idService.dart';

class GetOrderByIdController extends GetxController {
  var userINfo = OrderServiceModel().obs;
  ...
  Future fetchgetorderbyid() async {
    isLoading(true).obs;
    isListNull(true).obs;
    var detail = await get_orders_by_driver_idService.fetchGetOrdersByDriverId();
    if (detail == 600) {
      isLoading(false).obs;
      isListNull(true).obs;
