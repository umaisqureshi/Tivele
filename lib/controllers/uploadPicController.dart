...
import 'package:tivele/services/uploadPicService.dart';
class UploadPicController extends GetxController {
  var picINfo = CheckApiResponseM().obs;
  var isLoading = false.obs;
  int index = 0;
  void fetchPic(File file,String filename, int checkApi, String name) async {
    isLoading(true).obs;
