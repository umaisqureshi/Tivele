...
import 'package:tivele/services/loginService.dart';
...
class LoginController extends GetxController {
  var loginINfo = LoginM().obs;
  var isLoading = false.obs;
  void fetchLogin(Map<String, Object> userData, int checkApi, bool remember) async {
    isLoading(true).obs;
    ...
    if (detail["status"] == 100) {
      ...
      isLoading(false).obs;
      Get.offAll(VerificationCodePage(), arguments: [detail["data"],userData["email"]]);
    }else if (detail != null) {
      print("login");
      try {
